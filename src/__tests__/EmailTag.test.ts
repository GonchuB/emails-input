...
function createTestComponent({ onDelete = noop as DeleteHandler, email = defaultEmail } = {}): Component {
    return EmailTag({
        onDelete,
        email,
        uniqueId: '',
...
describe('EmailTag component', function () {
    describe('render', function () {
        ...
        it('renders valid email properly', function () {
            ...
            const emailTagElement = emailTag.render();
            expect(emailTagElement.getAttribute('class')).toEqual(
                'emails-input--email-tag emails-input--email-tag--valid',
            );
        });
        it('renders invalid email properly', function () {
            ...
            const emailTagElement = emailTag.render();
            expect(emailTagElement.getAttribute('class')).toEqual(
                'emails-input--email-tag emails-input--email-tag--invalid',
            );
        });
    });
